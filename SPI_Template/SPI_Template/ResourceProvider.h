		...
		class ResourceProvider : public SPICE::BIG::IResourceProvider
		{
			public:
				...
				*/
				...
				/**
					Sets the specificCoreContainer

					@param specificCoreContainer The specificCoreContainer
				*/
				void setSpecificCoreContainer(std::shared_ptr<SpecificCoreContainer> specificCoreContainer);

		private:

			std::shared_ptr<SpecificCoreContainer> _specificCoreContainer;
			std::shared_ptr<SPICE::BIG::DataSet> _parameterSet;
			std::map<int, std::shared_ptr<SPICE::BIG::DataSet>> _configSets;
